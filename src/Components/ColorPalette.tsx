      ...
      {cssCode && (
        <div className="mt-10">
          ...
          <div className="relative">
            ...
            <button 
              onClick={() => copyToClipboard(cssCode)}
              className="absolute top-2 right-2 p-1.5 bg-white rounded-md text-gray-500 hover:text-cyan-600 hover:bg-gray-50 transition-colors border border-gray-200 cursor-pointer"
            >
